...
- (void)setupDefaultColorStates {
    ...
    if ([self respondsToSelector:@selector(tintColor)]) {
        defaultActiveColor = [UIColor whiteColor];
    } else {
        // iOS 6
        defaultActiveColor = [UIColor whiteColor];
    }
    
    self.floatingLabelActiveTextColor = [UIColor whiteColor];
    self.floatingLabelInactiveTextColor = [UIColor lightGrayColor];
    self.floatingLabel.textColor = [UIColor whiteColor];
}
