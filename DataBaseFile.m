...
-(void)CopyDatabaseInDevice
{
  ...
  //  KidsDB.sqlite
    ...
    NSString *sourcepath = [[NSBundle mainBundle] pathForResource:@"JasVisa_DB" ofType:@"rdb"]; // get source path
    ...
    NSLog(@"IMAGE PATH>> %@",self.ImageFolderPath);

    strDestPath = [strDestPath stringByAppendingPathComponent:@"JasVisa_DB.rdb"]; // slash add karava mate
